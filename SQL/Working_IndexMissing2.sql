SELECT	 TOP 100
		 ...
		 'Avg_Estimated_Impact ', dm_migs.avg_user_impact*(dm_migs.user_seeks+dm_migs.user_scans) Avg_Estimated_Impact,
...
WHERE	 dm_mid.database_ID = DB_ID() and 
		 dm_migs.avg_user_impact*(dm_migs.user_seeks+dm_migs.user_scans) > 10000
